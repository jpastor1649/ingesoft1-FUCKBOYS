...
class ServicioEnergia:
    ...
    def crear_detalle(self, reci_id: int, piso: int, consumo: float,
                     tarifa_kwh: float, descuento: int) -> bool:
        """
        ...
        fields = ['ener_reci_id', 'ener_piso', 'ener_consumo', 'ener_tarifaKWH', 'ener_descuento']
    ...
    def calcular_eficiencia_energetica(self, reci_id: int, personas_edificio: int) -> Dict[str, float]:
        """
    ...
    def calcular_eficiencia_energetica(self, reci_id: int, personas_edificio: int) -> Dict[str, float]:
        ...
        eficiencia_economica = calculo['valor_total'] / consumo_total if consumo_total > 0 else 0.0
    ...
    def _validar_datos(self, piso: int, consumo: float, tarifa_kwh: float, descuento: int) -> bool:
        """
