...
class CalculadoraRecibos:
    ...
    def calcular_recibo_apartamento_mes(self, apar_id: int, mes: str) -> Dict[str, Any]:
        ...
        return {
            ...
            'arriendo': {
                ...
                'estado': arriendo.get('estado', 'SIN_DATOS') if arriendo else 'SIN_DATOS'
            },
            'servicios': servicios,
    ...
    def calcular_factor_consumo_apartamento(self, apar_id: int, mes: str, servicio: str) -> float:
        ...
        for apt in apartamentos:
            consumo_total += self._obtener_consumo_apartamento(apt['apar_id'], mes, servicio)
    ...
    def _calcular_servicio_apartamento(self, apar_id: int, mes: str, servicio: str) -> float:
        """
    ...
    def _obtener_recibo_servicio_mes(self, mes: str, servicio: str) -> Optional[Dict[str, Any]]:
    ...
    def _obtener_consumo_apartamento(self, apar_id: int, mes: str, servicio: str) -> float:
