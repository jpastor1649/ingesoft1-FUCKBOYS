...
class ServicioGas:
    ...
    def crear_detalle(self, reci_id: int, consumo: float, tarifa_fija: float, tarifa_m3: float) -> bool:
        """
    ...
    def actualizar(self, reci_id: int, consumo: float, tarifa_fija: float, tarifa_m3: float) -> bool:
        """
    ...
    def analizar_eficiencia_consumo(self, reci_id: int) -> Dict[str, Any]:
        ...
        return {
            ...
            'porcentaje_tarifa_fija': round((calculo['valor_fijo'] / valor_total) * 100, 2) if valor_total > 0 else 0
        }
    ...
    def _validar_datos(self, consumo: float, tarifa_fija: float, tarifa_m3: float) -> bool:
        """
