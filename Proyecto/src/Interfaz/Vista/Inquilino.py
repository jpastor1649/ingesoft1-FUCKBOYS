...
from Vista.Modulos_Inquilinos.Mihogar import MiHogar
from Vista.Modulos_Inquilinos.Gestion_usuario import GestionUsuario
from Vista.Modulos_Inquilinos.Recibos_Historial import ReportesYRecibos
from Vista.Modulos_Inquilinos.Arriendos import ConfiguracionArriendoUsuario

class PanelInquilino(QMainWindow):
    def __init__(self):
        super().__init__()
        # No crear widgets de módulos aquí, solo los fijos (título y label)
        self.setWindowTitle("Panel Inquilino")
        ...
        self.menu_frame.setFixedWidth(300)
        ...
        logo = QLabel()
        pixmap = QPixmap("Assets/Iconos/CERDO.png")
        ...
        menu_items = [
            ("Mi Hogar", "Assets\Iconos\miHogar.png"),
            ("Mi perfil", "Assets\Iconos\miPerfil.png"),
            ("Reportes y Recibos", "Assets\Iconos\\reportesR.png"),
            ("Configuración de \n Arriendos", "Assets\Iconos\confiarriendo.png"),
        ]
        ...
        self.cerrar_btn.setIcon(QIcon("Assets\Iconos\salida_inquilino.png"))  # Cambia el icono si prefieres otro
        self.cerrar_btn.setIconSize(QSize(50, 50))
    ...
    def cambiar_contenido(self, titulo):
        ...
        elif titulo.startswith("Mi Hogar"):
            widget = MiHogar()
            self.content_layout.addWidget(widget)
            
        elif titulo.startswith("Mi perfil"):
            widget = GestionUsuario()
            self.content_layout.addWidget(widget)

        elif titulo.startswith("Reportes y Recibos"):
            widget = ReportesYRecibos()
            self.content_layout.addWidget(widget)

        elif titulo.startswith("Configuración de Arriendos"):
            widget = ConfiguracionArriendoUsuario()
            self.content_layout.addWidget(widget)
